...
/**
 * Handles the Shopify shop/redact webhook.
 *
 * This endpoint should remove all data associated with a shop after app uninstallation.
 * Implement the necessary logic to delete or anonymise the shop data from your database.
 */
export const action = async ({ request }) => {
  ...
  console.log("✅ shop/redact webhook received:", payload);

  // TODO: Add logic to remove all stored data for the shop from your database.
  // If your app does not store any shop-specific data, you may simply log the event.
